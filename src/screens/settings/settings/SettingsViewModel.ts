...
export const useSettingsViewModel = () => {
  ...
  const settingsItems = [
    { id: 1, title: 'My Receiving Order', icon: Images.groupboxIcon, onPress: () => NavigationService.navigate(RouteConstant.ReceivingOrderHistory, { isFromSettings: true, title: 'My Receiving Order' }) },
    { id: 2, title: 'My Reviews', icon: Images.myReviews, onPress: () => NavigationService.navigate(RouteConstant.MyReviews) },
    { id: 3, title: 'Change Password', icon: Images.changePasswordListIcon, onPress: () => NavigationService.navigate(RouteConstant.ChangePassword) },
