...
import { useItemDetailsViewModel, ITEM_TYPES } from './ItemDetailsViewModel';
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <Pressable
            ...
            hitSlop={10}
            style={{ alignItems: 'flex-end', padding: 5, marginTop: 5 }}
          >
          ...
          <View style={styles.centerView}>
            <Modal
              ...
              animationType="fade"
              onRequestClose={() => {
                setVisible(false), setPickerVisible(false);
              }}
            >
              <View style={styles.centerView}>
